...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
	...
	private final AndroidMediaPlayerListenerHolderLiao mInternalListenerAdapter;
	...
	public AndroidMediaPlayer() {
		...
		mInternalListenerAdapter = new AndroidMediaPlayerListenerHolderLiao(this);
	...
	public void setDataSource(IMediaDataSource mediaDataSource) {
		...
		mMediaDataSource = new MediaDataSourceProxyLiao(mediaDataSource);
		mInternalMediaPlayer.setDataSource(mMediaDataSource);
	}

	@TargetApi(Build.VERSION_CODES.M)
	private static class MediaDataSourceProxyLiao extends MediaDataSource {
		private final IMediaDataSource mMediaDataSource;

		public MediaDataSourceProxyLiao(IMediaDataSource mediaDataSource) {
	...
	private class AndroidMediaPlayerListenerHolderLiao implements
		...
		public AndroidMediaPlayerListenerHolderLiao(AndroidMediaPlayer mp) {
