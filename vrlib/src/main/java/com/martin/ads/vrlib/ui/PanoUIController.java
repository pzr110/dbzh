...
//        screenshotBtn= (ImageView) controlToolbar.findViewById(R.id.screenshot_btn);
        ...
        dualScreenBtn = (ToggleButton) progressToolbar.findViewById(R.id.dualScreen_btn);

//        boolean live = mPano360ConfigBundle.isLive();
//        if (live) {
//            ToastUtils.showShort("直播");
//        } else {
//            ToastUtils.showShort("不是");
//        }
...
//        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtils.finishActivity(PanoPlayerActivity.class);
            }
        });
